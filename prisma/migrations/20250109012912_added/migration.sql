/*
  ...
  - You are about to alter the column `createdAt` on the `tokens` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
...
-- AlterTable
ALTER TABLE `tokens` MODIFY `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
